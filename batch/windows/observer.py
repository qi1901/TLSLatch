...
class Observer:
    def __init__(self, iface, server, client, outbound, main_port=19443):
        self.dll_dir = os.add_dll_directory(r"C:\Windows\System32\Npcap")
        self.lib = C.CDLL(r"C:\Windows\System32\Npcap\wpcap.dll")
        l = self.lib
        signatures = {
        ...
        self.direction_result = l.pcap_setdirection(self.handle, 2 if outbound else 1)
